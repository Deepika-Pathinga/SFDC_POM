...
public class SFDC_TC_09 extends SFDC_Test_Base {

	@Test(dataProvider = "data-provider-url,username,password")
	public static void TC_17_Pipeline(String url, String username, String password) throws InterruptedException {
		logger = report.startTest("TC_17_Pipeline");
		logger.log(LogStatus.INFO, "Starting SFDC TC_17_Pipeline...");
		...
		// Step 3: Click opportunity Pipeline link
		Thread.sleep(5000);
		HP.clickOnOpportunitiesPipeline();

		Thread.sleep(5000);
		// Opportunities page should be displayed
		String expectedpipe = "Opportunity Pipeline ~ Salesforce - Developer Edition";
		String actualpipe = driver.getTitle();

		if (actualpipe.equalsIgnoreCase(expectedpipe)) {
		...
		logger.log(LogStatus.INFO, "TC_17_Pipeline completed successfully");
